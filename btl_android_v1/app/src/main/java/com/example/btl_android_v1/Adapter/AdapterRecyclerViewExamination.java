...
import static com.example.btl_android_v1.Activities.Examination_Activity.list;


public class AdapterRecyclerViewExamination extends RecyclerView.Adapter<AdapterRecyclerViewExamination.RecyclerViewHolder> {
    Quetion cauHoi;
    int pos;
    Context context;
    private LayoutInflater mInflater;
    public AdapterRecyclerViewExamination(Context context, Quetion cauHoi, int pos) {
        this.cauHoi = cauHoi;
