...
import static com.example.btl_android_v1.Activities.ThiSatHach1_Activity.list;


public class AdapterRecyclerView_ThiSatHach extends RecyclerView.Adapter<AdapterRecyclerView_ThiSatHach.RecyclerViewHolder> {
    CauHoi cauHoi;
    int pos;
    Context context;
    private LayoutInflater mInflater;
    public AdapterRecyclerView_ThiSatHach(Context context, CauHoi cauHoi, int pos) {
        this.cauHoi = cauHoi;
