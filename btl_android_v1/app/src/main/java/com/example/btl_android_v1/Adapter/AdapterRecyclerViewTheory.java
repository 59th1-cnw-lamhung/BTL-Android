...
public class AdapterRecyclerViewTheory extends RecyclerView.Adapter<AdapterRecyclerViewTheory.RecyclerViewHolder> {
    List<Quetion> listCauHoi = new ArrayList<Quetion>();
    Context context;
    private LayoutInflater mInflater;

    public AdapterRecyclerViewTheory(Context context, List<Quetion> listCauHoi) {
