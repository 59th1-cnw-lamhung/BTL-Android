...
import com.example.btl_android_v1.Databases.LyThuyet_Database;
...
public class CauHoi_Model {
    LyThuyet_Database lyThuyetDatabase;
    SQLiteDatabase database;
    public CauHoi_Model(Context context){
        lyThuyetDatabase = new LyThuyet_Database(context);
    }
    public void open(){
