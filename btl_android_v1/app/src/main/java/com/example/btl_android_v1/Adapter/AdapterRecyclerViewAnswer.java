...
public class AdapterRecyclerViewAnswer extends RecyclerView.Adapter<AdapterRecyclerViewAnswer.RecyclerViewHolder> {
    List<Quetion> listCauHoi = new ArrayList<Quetion>();
    Context context;
    private LayoutInflater mInflater;
    boolean[] checkDungSai;
    char c;
    public AdapterRecyclerViewAnswer(Context context, List<Quetion> listCauHoi, boolean[] checkDungSai, char c) {
