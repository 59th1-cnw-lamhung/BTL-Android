...
import com.example.btl_android_v1.Activities.DapAn_Activity;
...
public class AdapterRecyclerView_LichSu extends RecyclerView.Adapter<AdapterRecyclerView_LichSu.RecyclerViewHolder> {
    ...
    int dem = 0;
    public AdapterRecyclerView_LichSu(Context context, List<DeThi> listDeThi) {
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, final int position) {
        ...
        holder.bt_deThi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                pos = position;
                Intent intent_xemDapAn = new Intent(context, DapAn_Activity.class);
