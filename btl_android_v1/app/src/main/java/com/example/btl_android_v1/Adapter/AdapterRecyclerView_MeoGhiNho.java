...
public class AdapterRecyclerView_MeoGhiNho extends RecyclerView.Adapter<AdapterRecyclerView_MeoGhiNho.RecyclerViewHolder>
        implements StickyHeaderAdapter<AdapterRecyclerView_MeoGhiNho.HeaderHolder> {
    List<MeoGhiNho> listMeoGhiNho = new ArrayList<MeoGhiNho>();
    Context context;
    private LayoutInflater mInflater;
    public AdapterRecyclerView_MeoGhiNho(Context context, List<MeoGhiNho> listMeoGhiNho) {
