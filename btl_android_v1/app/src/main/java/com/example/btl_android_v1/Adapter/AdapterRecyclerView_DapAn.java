...
public class AdapterRecyclerView_DapAn extends RecyclerView.Adapter<AdapterRecyclerView_DapAn.RecyclerViewHolder> {
    List<CauHoi> listCauHoi = new ArrayList<CauHoi>();
    Context context;
    private LayoutInflater mInflater;
    boolean[] checkDungSai;
    char c;
    public AdapterRecyclerView_DapAn(Context context, List<CauHoi> listCauHoi, boolean[] checkDungSai, char c) {
