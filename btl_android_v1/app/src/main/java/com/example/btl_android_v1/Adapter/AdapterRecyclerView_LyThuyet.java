...
public class AdapterRecyclerView_LyThuyet extends RecyclerView.Adapter<AdapterRecyclerView_LyThuyet.RecyclerViewHolder> {
    List<CauHoi> listCauHoi = new ArrayList<CauHoi>();
    Context context;
    private LayoutInflater mInflater;

    public AdapterRecyclerView_LyThuyet(Context context, List<CauHoi> listCauHoi) {
