...
public class AdapterRecyclerView_BienBao extends RecyclerView.Adapter<AdapterRecyclerView_BienBao.RecyclerViewHolder> implements StickyHeaderAdapter<AdapterRecyclerView_BienBao.HeaderHolder> {
    List<BienBao> listBienBao = new ArrayList<BienBao>();
    Context context;
    private LayoutInflater mInflater;
    public AdapterRecyclerView_BienBao(Context context, List<BienBao> listBienBao) {
