...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, Runnable{
    ...
    private int[] image = new int[]{
            R.drawable.b5, R.drawable.b2, R.drawable.b4, R.drawable.b3, R.drawable.b6
    };
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.bt_bienBao:
                Intent intentBienBao = new Intent(this, Noticeboard_Activity.class);
            ...
            case R.id.bt_lyThuyet:
                Intent intentLyThuyet = new Intent(this, Theory_Activity.class);
            ...
            case R.id.bt_meoGhiNho:
                Intent intentMeoGhiNho = new Intent(this, Memorize_Activity.class);
            ...
            case R.id.bt_lichSuBaiThi:
                Intent intent_lichsu = new Intent(MainActivity.this, HistoryExam_Activity.class);
                ...
                break;
            case R.id.bt_a121:
                Intent intentThiSatHachA = new Intent(MainActivity.this, Examination_Activity.class);
                ...
                break;
            case R.id.bt_b121:
                Intent intentThiSatHachB = new Intent(MainActivity.this, Examination_Activity.class);
            ...
            case R.id.bt_cancel1:
                ...
                break;
            case R.id.bt_a122:
                Intent intentThucHanhA = new Intent(this, Practice1_Activity.class);
                ...
                break;
            case R.id.bt_b122:
                Intent intentThucHanhB = new Intent(this, Practice2_Activity.class);
