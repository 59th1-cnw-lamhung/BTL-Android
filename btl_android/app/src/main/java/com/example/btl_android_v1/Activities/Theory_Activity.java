...
import com.example.btl_android_v1.Adapter.AdapterRecyclerViewTheory;
...
public class Theory_Activity extends AppCompatActivity implements View.OnClickListener{
    RecyclerView rcv_lyTHuyet;
    Button bt_truoc, bt_sau;
    AdapterRecyclerViewTheory adapterRecyclerViewLyThuyet;
    int dem = 1;
    ...
    public void setControl(){
        ...
        adapterRecyclerViewLyThuyet = new AdapterRecyclerViewTheory(this,cauHoiDAO.getListCauHoi(dem));
        ...
        if (view==bt_truoc){
            if (dem!=1){
                ...
                adapterRecyclerViewLyThuyet
                        = new AdapterRecyclerViewTheory(Theory_Activity.this,cauHoiDAO.getListCauHoi(dem));
                rcv_lyTHuyet.setAdapter(adapterRecyclerViewLyThuyet);
            }
        } else {
            if (dem!=18){
