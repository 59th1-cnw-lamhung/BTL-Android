...
public class AdapterRecyclerViewNoticeboard extends RecyclerView.Adapter<AdapterRecyclerViewNoticeboard.RecyclerViewHolder> implements StickyHeaderAdapter<AdapterRecyclerViewNoticeboard.HeaderHolder> {
    List<Noticeboard> listBienBao = new ArrayList<Noticeboard>();
    Context context;
    private LayoutInflater mInflater;
    public AdapterRecyclerViewNoticeboard(Context context, List<Noticeboard> listBienBao) {
    ...
    public RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = mInflater.inflate(R.layout.layout_recyclerview_bienbao,parent,false);//đổ dữ liệu vào View
