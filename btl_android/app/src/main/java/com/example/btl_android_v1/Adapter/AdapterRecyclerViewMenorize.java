...
public class AdapterRecyclerViewMenorize extends RecyclerView.Adapter<AdapterRecyclerViewMenorize.RecyclerViewHolder>
        implements StickyHeaderAdapter<AdapterRecyclerViewMenorize.HeaderHolder> {
    List<Memorize> listMeoGhiNho = new ArrayList<Memorize>();
    Context context;
    private LayoutInflater mInflater;
    public AdapterRecyclerViewMenorize(Context context, List<Memorize> listMeoGhiNho) {
