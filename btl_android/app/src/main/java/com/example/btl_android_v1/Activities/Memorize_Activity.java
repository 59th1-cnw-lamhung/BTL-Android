...
import com.example.btl_android_v1.Adapter.AdapterRecyclerViewMenorize;
import com.example.btl_android_v1.Model.Memorize_Model;
...
public class Memorize_Activity extends AppCompatActivity {
    RecyclerView rcv_meoGhiNho;
    AdapterRecyclerViewMenorize adapterRecyclerViewMeoGhiNho;
    Memorize_Model meoGhiNhoDAO;
    ...
    public void setControl(){
        ...
        meoGhiNhoDAO = new Memorize_Model(this);
        adapterRecyclerViewMeoGhiNho = new AdapterRecyclerViewMenorize(this,meoGhiNhoDAO.getListMeoGhiNho());
        ...
        btn_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                android.support.v7.widget.PopupMenu popupMenu
                        = new android.support.v7.widget.PopupMenu(Memorize_Activity.this,btn_menu);
                        ...
                        switch (item.getItemId()){
                            case R.id.item_tatca:
                                adapterRecyclerViewMeoGhiNho
                                        = new AdapterRecyclerViewMenorize(Memorize_Activity.this,meoGhiNhoDAO.getListMeoGhiNho());
                            ...
                            case R.id.item_meolythuyet:
                                adapterRecyclerViewMeoGhiNho
                                        = new AdapterRecyclerViewMenorize(Memorize_Activity.this,meoGhiNhoDAO.getListMeoLyThuyet());
                                rcv_meoGhiNho.removeItemDecoration(decor);
                                decor = new StickyHeaderDecoration(adapterRecyclerViewMeoGhiNho);
                                rcv_meoGhiNho.addItemDecoration(decor, 1);
                                rcv_meoGhiNho.setAdapter(adapterRecyclerViewMeoGhiNho);
                            ...
                            case R.id.item_meobienbao:
                                adapterRecyclerViewMeoGhiNho
                                        = new AdapterRecyclerViewMenorize(Memorize_Activity.this,meoGhiNhoDAO.getListMeoBienBao());
                                rcv_meoGhiNho.removeItemDecoration(decor);
                                decor = new StickyHeaderDecoration(adapterRecyclerViewMeoGhiNho);
                                rcv_meoGhiNho.addItemDecoration(decor, 1);
                                rcv_meoGhiNho.setAdapter(adapterRecyclerViewMeoGhiNho);
                            ...
                            case R.id.item_meosahinh:
                                adapterRecyclerViewMeoGhiNho
                                        = new AdapterRecyclerViewMenorize(Memorize_Activity.this,meoGhiNhoDAO.getListMeoSaHinh());
                                rcv_meoGhiNho.removeItemDecoration(decor);
                                decor = new StickyHeaderDecoration(adapterRecyclerViewMeoGhiNho);
                                rcv_meoGhiNho.addItemDecoration(decor, 1);
                                rcv_meoGhiNho.setAdapter(adapterRecyclerViewMeoGhiNho);
